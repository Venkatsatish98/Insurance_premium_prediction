...
class DataIngestion:
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
        try:
            ...
            insurance_premium_data_frame["bmi_category"] = pd.cut(
                insurance_premium_data_frame["bmi"],
            ...
            for train_index,test_index in split.split(insurance_premium_data_frame, insurance_premium_data_frame["bmi_category"]):
                strat_train_set = insurance_premium_data_frame.loc[train_index].drop(["bmi_category"],axis=1)
                strat_test_set = insurance_premium_data_frame.loc[test_index].drop(["bmi_category"],axis=1)
