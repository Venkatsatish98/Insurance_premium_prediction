...
from insurance_premium.entity.insurance_premium_predictor import insuranceData, InsurancePremiumPredictor
...
def predict():
    ...
    try:
        if request.method == 'POST':
            ...
            premium_data = insuranceData(age=age,
                                    sex=sex,
                                    bmi=bmi,
                                    children=children,
                                    smoker=smoker,
        ...
        return str(InsurancePremiumException(e,sys))
